...
public class Producto {
	...
	// GENERAR PRODUCTOS
	// Puedes generar tus productos como quieras, pero aqu� tienes una forma de hacerlo
	// que te ayudar� a ver si tu programa funciona bien o no.
	...
	public static List<Producto> generaProductos (int numProductos) {
		...
		for (int i=0;i<numProductos;i++) {
			...
			// precio = 1+r.nextDouble(Config.maximoPrecioProducto); // con precio aleatorio hasta el m�ximo del precio configurado
